...
public class HistogramDataPointsToDataPointsAdaptor implements DataPoints {
  ...
  public HistogramDataPointsToDataPointsAdaptor(final HistogramDataPoints hdps, final float percentile) {
  ...
  public String metricName() {
    return this.hist_data_points.metricName() + "_pct_" + Float.toString(this.percentile);
  }
