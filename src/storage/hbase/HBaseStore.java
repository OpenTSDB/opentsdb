...
public class HBaseStore implements TsdbStore {
   ...
   */
  @Override
  public Deferred<TreeMap<byte[], Span>> executeQuery(final TsdbQuery tsdbQuery) throws HBaseException {
   ...
   * @param tsdbQuery*/
  long getScanStartTimeSeconds(TsdbQuery tsdbQuery) {
   ...
   * @param tsdbQuery*/
  long getScanEndTimeSeconds(TsdbQuery tsdbQuery) {
    ...
    return end + Const.MAX_TIMESPAN + 1 + tsdbQuery.getSampleInterval() / 1000;
  }
   ...
   * @param tsdbQuery
   */
  public Scanner getScannerForQuery(TsdbQuery tsdbQuery) throws HBaseException {
    final short metric_width = Const.METRICS_WIDTH;
