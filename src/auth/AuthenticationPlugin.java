...
public abstract class AuthenticationPlugin {
  ...
  public abstract EmbeddedAccessKeyPair generateAccessToken(String adminAccessKey, String adminSecretKey);
  public abstract void storeCredentials(EmbeddedAccessKeyPair keyPair);
  public abstract void storeCredentials(String accessKey, String accessSecretKey);
  public abstract void removeCredentials(String adminAccessKey, String adminSecretKey, EmbeddedAccessKeyPair keyPair);
  public abstract void removeCredentials(String adminAccessKey, String adminSecretKey, String accessKey);
}
