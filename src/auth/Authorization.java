...
public abstract class Authorization {
   ...
   *
   * @param state      the AuthState from the channel
   * @param permission the permission to check for
   * @return returns true if the current user has this permission, false otherwise
   */
  public abstract boolean hasPermission(final AuthState state, final Roles.Permissions permission);
   ...
   * @return returns true if the current user has this role, false otherwise
   */
  public abstract boolean hasRole(final AuthState state, final Roles role);
  ...
  /**
   * Determines if the user is allowed to insert the given datapoint.
   *
   * @param state             A non-null auth state with the user and AuthStatus.SUCCESS.
   * @param incomingDataPoint A non-null datapoint.
   * @return An AuthState object with a valid AuthStatus to evaluate for
   * permission.
   */
  public abstract AuthState allowWrite(final AuthState state,
