...
final class TSDMain {
  ...
  public static void main(String[] args) {
    ...
    argp.addOption("--auto-metric",
                   "Automatically add metrics to tsdb as they are inserted\n"
                +"  warning: this may cause unexpected metrics to be tracked");
    ...
    System.setProperty("tsd.core.auto_create_metrics",
            String.valueOf(argp.has("--auto-metric")));
