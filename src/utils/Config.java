...
public class Config {
  ...
  */
  ...
  protected void setDefaults() {
    ...
    default_map.put("tsd.core.authorization.plugin", "net.opentsdb.auth.SimpleAuthorizationImpl");
    default_map.put("tsd.core.authentication.plugin", "net.opentsdb.auth.AllowAllAuthenticator");
