 ...
 * @since 3.0
 */
public class InfluxLineProtocolParserPool extends BaseObjectPoolAllocator {
  public static final String TYPE = "InfluxLineProtocolParserPool";
  public static final TypeToken<?> TYPE_TOKEN = TypeToken.of(
      InfluxLineProtocolParser.class);
