...
public class Tsdb1xBigtableFactory extends BaseTSDBPlugin implements Tsdb1xDataStoreFactory {
  ...
  /** The default clients. */
  protected volatile Tsdb1xBigtableDataStore default_client;
  ...
  public Deferred<Object> shutdown() {
    ...
    for (final Tsdb1xBigtableDataStore store : clients.values()) {
  ...
  public Tsdb1xDataStore newInstance(final TSDB tsdb, 
    ...
    if (Strings.isNullOrEmpty(id)) {
      if (default_client == null) {      
        synchronized (this) {
          if (default_client == null) {
            default_client = new Tsdb1xBigtableDataStore(this, null, schema);
          }
        }
      }
    ...
    Tsdb1xBigtableDataStore client = clients.get(id);
    if (client == null) {
      synchronized (this) {
        client = clients.get(id);
        if (client == null) {
          client = new Tsdb1xBigtableDataStore(this, id, schema);
