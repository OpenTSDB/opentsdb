...
public class TestAbstractPassThroughProcessor {
  ...
  public void syncTimestamp() throws Exception {
    ...
    verify(source, times(1)).syncTimestamp();
  }
  ...
  public void markStatus() throws Exception {
    ...
    verify(source, times(1)).markStatus(IteratorStatus.HAS_DATA);
  }
  ...
  public void setSyncTime() throws Exception {
    ...
    verify(source, times(1)).setSyncTime(ts);
  }
  ...
  class TestImp extends AbstractPassThroughProcessor<TestImp> {
