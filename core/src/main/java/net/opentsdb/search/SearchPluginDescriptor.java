...
public abstract class SearchPluginDescriptor {
   ...
   * throw exceptions if they can't start up properly. The TSD will then shutdown so the operator
   * can fix the problem. Please use IllegalArgumentException for configuration issues.
   *
   ...
   */
  public abstract SearchPlugin create(Config config) throws Exception;
}
