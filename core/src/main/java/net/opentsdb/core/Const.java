...
public final class Const {
  ...
  /**
   * When this bit is set, the value is a floating point value. Otherwise it's an integer value.
   */
   ...
   * its contents leads to an undefined behavior.
   */
  ...
  /**
   * Necessary for rate calculations where we may be trying to convert a large Long value to a
