...
public interface Aggregator {
  ...
  interface Longs {
     ...
     *
     * @throws java.util.NoSuchElementException if calling {@link #hasNextValue} returns {@code
     * false}.
     */
    long nextLongValue();
  ...
  interface Doubles {
     ...
     *
     * @throws NoSuchElementException if calling {@link #hasNextValue} returns {@code false}.
     */
