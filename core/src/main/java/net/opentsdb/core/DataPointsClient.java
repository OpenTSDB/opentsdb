...
public class DataPointsClient {
   ...
   * <p/>
   * Each element in the non-{@code null} but possibly empty array returned corresponds to one time
   * series for which some data points have been matched by the query.
   * @since 1.2
   */
  // TODO
