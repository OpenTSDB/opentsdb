...
public interface DataPoint {
  ...
  /**
   * Returns the value of the this data point as a {@code double}, even if it's a {@code long}.
   *
   * @return When {@code isInteger() == false}, this method returns the same thing as {@link
   * #doubleValue}.  Otherwise, it returns the same thing as {@link #longValue}'s return value
   * casted to a {@code double}.
   */
  double toDouble();
