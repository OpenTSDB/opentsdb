 ...
 * and tags.
 * <p/>
 * Note: This is here for legacy reasons and to aid migration. Everything that accepts instances of
 * this as an argument should be refactored to accept the metric and tags separately instead
 */
@Deprecated
