...
public class DefaultEventQuery implements EventQuery {
  ...
  protected DefaultEventQuery(final Builder builder) {
   ...
   */
  public static class Builder extends EventQuery.Builder {

    public EventQuery build() {
      return new DefaultEventQuery(this);
    }
