...
@JsonDeserialize(builder = EventLiteralOrFilter.Builder.class)
public class EventLiteralOrFilter extends BaseEventFilter
   ...
   * @throws IllegalArgumentException if the field or filter were empty or null
   */
  protected EventLiteralOrFilter(final Builder builder) {
    super(builder.field, builder.filter);
...
//  }
  ...
  public static class Builder {
    ...
    public EventLiteralOrFilter build() {
      return new EventLiteralOrFilter(this);
    }
  }
}
