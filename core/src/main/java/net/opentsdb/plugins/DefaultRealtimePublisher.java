...
/**
 * A default realtime publisher to use when no other realtime publisher has been configured. This
 * realtime publisher will just discard all data given to it.
 *
