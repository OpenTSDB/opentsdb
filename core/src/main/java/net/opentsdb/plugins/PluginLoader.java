...
public final class PluginLoader {
   ...
   * @throws IllegalArgumentException if the plugin name is null or empty or no plugin with the
   ...
   *
   * @param type The class type to search for
   * @return An list of objects of the given type. If no objects were found an empty list will be
   * returned.
   * @throws ServiceConfigurationError if any of the plugins could not be instantiated
   */
