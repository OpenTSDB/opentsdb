...
public abstract class Plugin implements Closeable {
  /**
   * Should return the version of this plugin in the format: MAJOR.MINOR.MAINT, e.g. 2.0.1. The
   * MAJOR version should match the major version of OpenTSDB the plugin is meant to work with.
   *
