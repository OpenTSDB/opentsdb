 ...
 * wrong type for this implementation, {@link #merge(TimeSeriesId, List)} 
 * should throw an {@link IllegalArgumentException} exception.
 * <p>
 ...
 * is passed in to the {@link #merge(TimeSeriesId, List)} method. 
 * <p>
 * Also the 
 * 
