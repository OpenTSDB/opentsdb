 ...
 *
 * @param <T> The type of data the configuration entry is encoded as.
 * 
 * @since 3.0
 */
public interface ConfigurationCallback<T> {
  ...
  /**
   * Called from the configuration implementation only when a value has 
   * been updated upstream to a different value.
   * 
   * @param key The key of the setting.
   * @param value The value updated by the configuration. May be null if 
