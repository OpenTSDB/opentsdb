 ...
 * a {@link ConfigEntrySchema} to determine the key and type.
 * 
 * @since 3.0
 */
public class ConfigSetting {
   ...
   */
  protected ConfigSetting(final Builder builder) {
  ...
  public String toString() {
    return new StringBuilder()
        .append("value=")
        .append(value == null ? "null" : (obfuscate ? "********" : value))
        .append(", source=")
        .append(source)
        .append(", lastChange=")
        .append(last_change)
  ...
  public static class Builder {
    ...
    /** @return The constructed {@link ConfigSetting} */
