...
/**
 * Defines a class that can validate a value instance of a declared ConfigMetaType
 * 
 * @since 2.4
 */
public interface ConfigValueValidator {
   ...
   */
  public ValidationResult validate(final ConfigEntrySchema schema);
  
  /**
   * Validates a config setting override.
   * @param setting The setting to validate.
   * @return A non-null validation result.
   */
  public ValidationResult validate(final ConfigSetting setting);
