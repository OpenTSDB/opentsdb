...
public class TestSimpleHistogram {
  ...
  public void verifyE2EKryo() {
      ...
      output.writeByte(0 /* This is the type of histogram (or sketch) written to storage. HistoType.SimpleHistogramType.ordinal()*/);
      output.writeShort(8);
      ...
      System.out.println("Byte array ouput size: " + outBuffer.toByteArray().length);
  ...
  public void testJsonSerialization() {
    ...
    assertTrue("{\"buckets\":{\"5.0-7.0\":3,\"7.0-10.0\":5},\"underflow\":0,\"overflow\":1}".equals(jsonOut));
    ...
    System.out.println(jsonOut);
    assertTrue("{\"buckets\":{\"-Infinity-5.0\":3,\"7.0-10.0\":5},\"underflow\":0,\"overflow\":0}".equals(jsonOut));
  }
  ...
  public void testInit() {
      double[] dynaHist = SimpleHistogram.initializeHistogram(1.0f, 6000.0f, 100.0f, 2000.0f, 0.05f);
  ...
  public void testWholeRangeFocus() {
      double[] dynaHist = SimpleHistogram.initializeHistogram(100.0f, 2000.0f, 100.0f, 2000.0f, 0.05f);
      System.out.println("No. of buckets: " + dynaHist.length);
      for (int i = 0; i < dynaHist.length; i++) {
          System.out.print(dynaHist[i] + ", ");
      }
  ...
  public void testStartEqualtoFocusStart() {
      double[] dynaHist = SimpleHistogram.initializeHistogram(100.0f, 6000.0f, 100.0f, 2000.0f, 0.05f);
      System.out.println("No. of buckets: " + dynaHist.length);
      for (int i = 0; i < dynaHist.length; i++) {
          System.out.print(dynaHist[i] + ", ");
      }
  ...
  public void testEndEqualtoFocusEnd() {
      double[] dynaHist = SimpleHistogram.initializeHistogram(1.0f, 2000.0f, 100.0f, 2000.0f, 0.05f);
      System.out.println("No. of buckets: " + dynaHist.length);
      for (int i = 0; i < dynaHist.length; i++) {
          System.out.print(dynaHist[i] + ", ");
      }
  ...
  public void testErrorStartGreaterThanEnd() {
      double[] dynaHist = SimpleHistogram.initializeHistogram(10000.0f, 6000.0f, 100.0f, 2000.0f, 0.05f);
  }

  @Test (expected = RuntimeException.class)
  public void testErrorFocusStartGreaterThanFocusEnd() {
      double[] dynaHist = SimpleHistogram.initializeHistogram(1.0f, 6000.0f, 3000.0f, 2000.0f, 0.05f);
  }
  ...
  public void testFocusEndGreaterThanEnd() {
      double[] dynaHist = SimpleHistogram.initializeHistogram(1.0f, 1000.0f, 100.0f, 2000.0f, 0.05f);
  }

  @Test (expected = RuntimeException.class)
  public void testFocusStartLessThanStart() {
      double[] dynaHist = SimpleHistogram.initializeHistogram(200.0f, 100.0f, 1500.0f, 2000.0f, 0.05f);
  }

  @Test (expected = RuntimeException.class)
  public void testExcessiveBuckets() {
      double[] dynaHist = SimpleHistogram.initializeHistogram(100.0f, 6000.0f, 100.0f, 6000.0f, 0.01f);
  }
}