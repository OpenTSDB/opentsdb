...
public final class TestInternal {
  ...
  public void getSalt() {
    ...
    assertArrayEquals(new byte[] {}, Internal.getSaltBytes(2));
    
    PowerMockito.when(Const.SALT_WIDTH()).thenReturn(1);
    assertArrayEquals(new byte[] { 2 }, Internal.getSaltBytes(2));
    assertArrayEquals(new byte[] { 20 }, Internal.getSaltBytes(20));
    
    PowerMockito.when(Const.SALT_WIDTH()).thenReturn(2);
    assertArrayEquals(new byte[] { 0, 20 }, Internal.getSaltBytes(20));
    
    PowerMockito.when(Const.SALT_WIDTH()).thenReturn(4);
    assertArrayEquals(new byte[] { 0, 0, 0, 20 }, Internal.getSaltBytes(20));
  ...
  public void prefixKeyWithSaltNullKey() {
    setupSalt();
    Internal.prefixKeyWithSalt(null);
  }
